...
<body>
    ...
    Echo.channel('clientes')
        .listen('ClienteUpdated', (e) => {
            ...
            // Crea una nueva fila para el cliente
            const newRow = `
                <tr>
                    <td>
                        <a href="/cliente/${e.id}/edit" class="btn btn-warning btn-sm">EDITAR</a>
                        <form action="/cliente/${e.id}" method="post" style="display:inline;">
